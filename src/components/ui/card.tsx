...
>(({ className, ...props }, ref) => (
  <div // Changed from h3 to div to avoid semantic issues if used not as a direct heading
    ref={ref}
    className={cn(
      "text-lg font-normal text-primary leading-none tracking-tight", // Updated styles
      className
    )}
    {...props}
  />
